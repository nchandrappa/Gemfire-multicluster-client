...
public class TransactionCqClient {
	...
	public static void registerCq() throws QueryInvalidException,
		...
		Pool gemfire8Pool = PoolManager.find("clientPool");


		QueryService queryService = gemfire8Pool.getQueryService();
		Region<String,String> orders = cache.getRegion("orders");
